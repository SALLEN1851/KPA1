...
<a class="btn btn--primary type--uppercase" href="#purchase-template">Drop your resumé here</a>';
	...
	$ebor_options->add_setting('select', 'stack_single_post_embed_cover', 'Show featured image over video embeds?', 'blog_single_section', 'yed', 30, $yesNo);
	...
	$ebor_options->add_setting('select', 'stack_simple_list_thumbnail', 'Show featured image in Simple List layout?', 'blog_archive_section', 'no', 35, $yesNo);
